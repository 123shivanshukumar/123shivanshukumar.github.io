...
Again relates to the first point (mentioned previously in [this](https://123shivanshukumar.github.io/posts/thoughts/) post) -- I have a bad habit of holding opinions over people -- I realised only recently that this is flawed on two counts:
1. people change over time -- Yukash, a good friend of mine pointed out
2. people have different dimensions to their behaviour

Even if 1 isnt true 2 holds very well -- it is the value that we gain from people that we should focus on rather than some tiny annoyance that our mind has given birth to. People are a leverage (I AM BY NO MEANS SAYING USE PEOPLE). If you hold opinions on people or let ur ego dominate, there is a high potential value addition that u r missing out. 
